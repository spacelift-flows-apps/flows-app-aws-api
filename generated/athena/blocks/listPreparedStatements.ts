...
const listPreparedStatements: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListPreparedStatementsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Prepared Statements Result",
      description: "Result from ListPreparedStatements operation",
...
export default listPreparedStatements;
