...
const updatePreparedStatement: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdatePreparedStatementCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Prepared Statement Result",
      description: "Result from UpdatePreparedStatement operation",
...
export default updatePreparedStatement;
