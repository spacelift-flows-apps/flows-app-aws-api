...
const batchGetNamedQuery: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new BatchGetNamedQueryCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Batch Get Named Query Result",
      description: "Result from BatchGetNamedQuery operation",
...
export default batchGetNamedQuery;
