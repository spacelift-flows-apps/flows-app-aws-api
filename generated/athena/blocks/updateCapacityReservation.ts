...
const updateCapacityReservation: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateCapacityReservationCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Update Capacity Reservation Result",
      description: "Result from UpdateCapacityReservation operation",
...
export default updateCapacityReservation;
