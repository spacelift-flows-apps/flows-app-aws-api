...
const createPreparedStatement: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreatePreparedStatementCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Create Prepared Statement Result",
      description: "Result from CreatePreparedStatement operation",
...
export default createPreparedStatement;
