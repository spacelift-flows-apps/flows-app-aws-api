...
const updateNotebookMetadata: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateNotebookMetadataCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Notebook Metadata Result",
      description: "Result from UpdateNotebookMetadata operation",
...
export default updateNotebookMetadata;
