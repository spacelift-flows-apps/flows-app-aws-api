...
const deleteWorkGroup: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteWorkGroupCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Work Group Result",
      description: "Result from DeleteWorkGroup operation",
...
export default deleteWorkGroup;
