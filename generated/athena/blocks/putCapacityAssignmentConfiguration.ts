...
const putCapacityAssignmentConfiguration: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new PutCapacityAssignmentConfigurationCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Put Capacity Assignment Configuration Result",
      description: "Result from PutCapacityAssignmentConfiguration operation",
...
export default putCapacityAssignmentConfiguration;
