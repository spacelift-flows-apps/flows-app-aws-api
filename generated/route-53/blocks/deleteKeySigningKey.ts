...
const deleteKeySigningKey: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteKeySigningKeyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Key Signing Key Result",
      description: "Result from DeleteKeySigningKey operation",
...
export default deleteKeySigningKey;
