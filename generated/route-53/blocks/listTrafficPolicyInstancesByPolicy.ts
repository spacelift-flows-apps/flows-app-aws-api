...
const listTrafficPolicyInstancesByPolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListTrafficPolicyInstancesByPolicyCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Traffic Policy Instances By Policy Result",
      description: "Result from ListTrafficPolicyInstancesByPolicy operation",
...
export default listTrafficPolicyInstancesByPolicy;
