...
const sendTaskSuccess: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new SendTaskSuccessCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Send Task Success Result",
      description: "Result from SendTaskSuccess operation",
