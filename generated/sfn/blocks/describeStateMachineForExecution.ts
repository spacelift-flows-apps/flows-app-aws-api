...
const describeStateMachineForExecution: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe State Machine For Execution Result",
      description: "Result from DescribeStateMachineForExecution operation",
...
export default describeStateMachineForExecution;
