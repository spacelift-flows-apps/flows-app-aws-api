...
import { SFNClient, GetActivityTaskCommand } from "@aws-sdk/client-sfn";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const getActivityTask: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetActivityTaskCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Get Activity Task Result",
      description: "Result from GetActivityTask operation",
      ...
      type: {
        ...
        properties: {
          taskToken: {
            type: "string",
            description: "A token that identifies the scheduled task.",
          },
          input: {
            type: "string",
            description:
