...
import { SFNClient, UpdateMapRunCommand } from "@aws-sdk/client-sfn";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const updateMapRun: AppBlock = {
  name: "Update Map Run",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateMapRunCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Map Run Result",
      description: "Result from UpdateMapRun operation",
