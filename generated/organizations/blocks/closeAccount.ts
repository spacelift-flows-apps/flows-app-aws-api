...
const closeAccount: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CloseAccountCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Close Account Result",
      description: "Result from CloseAccount operation",
