...
const listParents: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListParentsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Parents Result",
      description: "Result from ListParents operation",
