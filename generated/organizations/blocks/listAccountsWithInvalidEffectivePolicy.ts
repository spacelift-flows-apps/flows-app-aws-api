...
const listAccountsWithInvalidEffectivePolicy: AppBlock = {
  name: "List Accounts With Invalid Effective Policy",
  description: `Lists all the accounts in an organization that have invalid effective policies.`,
  inputs: {
    default: {
      config: {
        region: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListAccountsWithInvalidEffectivePolicyCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Accounts With Invalid Effective Policy Result",
      description:
        "Result from ListAccountsWithInvalidEffectivePolicy operation",
...
export default listAccountsWithInvalidEffectivePolicy;
