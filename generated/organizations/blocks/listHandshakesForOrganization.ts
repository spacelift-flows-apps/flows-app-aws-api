...
const listHandshakesForOrganization: AppBlock = {
  name: "List Handshakes For Organization",
  description: `Lists the recent handshakes that you have sent.`,
  inputs: {
    default: {
      config: {
        region: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListHandshakesForOrganizationCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Handshakes For Organization Result",
      description: "Result from ListHandshakesForOrganization operation",
...
export default listHandshakesForOrganization;
