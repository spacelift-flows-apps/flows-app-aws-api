...
const listDelegatedAdministrators: AppBlock = {
    ...
    default: {
      config: {
        ...
        ServicePrincipal: {
          ...
          description: "Specifies a service principal name.",
          type: "string",
          required: false,
        },
        NextToken: {
  ...
  outputs: {
    default: {
      name: "List Delegated Administrators Result",
      description: "Result from ListDelegatedAdministrators operation",
...
export default listDelegatedAdministrators;
