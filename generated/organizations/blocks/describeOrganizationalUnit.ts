...
const describeOrganizationalUnit: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Organizational Unit Result",
      description: "Result from DescribeOrganizationalUnit operation",
...
export default describeOrganizationalUnit;
