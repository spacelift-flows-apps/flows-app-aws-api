...
const listOrganizationalUnitsForParent: AppBlock = {
  ...
  outputs: {
    default: {
      name: "List Organizational Units For Parent Result",
      description: "Result from ListOrganizationalUnitsForParent operation",
...
export default listOrganizationalUnitsForParent;
