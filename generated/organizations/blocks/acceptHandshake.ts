...
const acceptHandshake: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new AcceptHandshakeCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Accept Handshake Result",
      description: "Result from AcceptHandshake operation",
...
export default acceptHandshake;
