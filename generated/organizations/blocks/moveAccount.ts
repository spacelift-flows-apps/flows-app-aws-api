...
const moveAccount: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new MoveAccountCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Move Account Result",
      description: "Result from MoveAccount operation",
