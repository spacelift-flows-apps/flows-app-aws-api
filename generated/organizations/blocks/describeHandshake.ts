...
const describeHandshake: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeHandshakeCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Describe Handshake Result",
      description: "Result from DescribeHandshake operation",
...
export default describeHandshake;
