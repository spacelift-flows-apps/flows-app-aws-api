...
const enablePolicyType: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new EnablePolicyTypeCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Enable Policy Type Result",
      description: "Result from EnablePolicyType operation",
...
export default enablePolicyType;
