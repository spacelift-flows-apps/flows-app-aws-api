...
const deleteDBCluster: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteDBClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete DB Cluster Result",
      description: "Result from DeleteDBCluster operation",
