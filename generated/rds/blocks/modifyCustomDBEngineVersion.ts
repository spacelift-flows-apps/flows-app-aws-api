...
const modifyCustomDBEngineVersion: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ModifyCustomDBEngineVersionCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Modify Custom DB Engine Version Result",
      description: "Result from ModifyCustomDBEngineVersion operation",
...
export default modifyCustomDBEngineVersion;
