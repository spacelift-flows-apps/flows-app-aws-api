...
const startDBInstance: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new StartDBInstanceCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Start DB Instance Result",
      description: "Result from StartDBInstance operation",
...
export default startDBInstance;
