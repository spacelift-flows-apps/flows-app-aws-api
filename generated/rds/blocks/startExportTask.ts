...
const startExportTask: AppBlock = {
    ...
    default: {
      config: {
        ...
        ExportTaskIdentifier: {
          ...
          description: "A unique identifier for the export task.",
          type: "string",
          required: true,
        },
        SourceArn: {
        ...
        ExportOnly: {
          name: "Export Only",
          description: "The data to be exported from the snapshot or cluster.",
          type: {
            type: "array",
            items: {
              type: "string",
      ...
      onEvent: async (input) => {
        ...
        const command = new StartExportTaskCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Start Export Task Result",
      description: "Result from StartExportTask operation",
...
export default startExportTask;
