...
const stopDBCluster: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new StopDBClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Stop DB Cluster Result",
      description: "Result from StopDBCluster operation",
