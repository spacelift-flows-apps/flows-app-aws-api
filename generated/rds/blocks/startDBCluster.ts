...
const startDBCluster: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new StartDBClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Start DB Cluster Result",
      description: "Result from StartDBCluster operation",
