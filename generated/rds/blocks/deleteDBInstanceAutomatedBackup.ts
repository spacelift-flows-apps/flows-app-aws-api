...
const deleteDBInstanceAutomatedBackup: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Delete DB Instance Automated Backup Result",
      description: "Result from DeleteDBInstanceAutomatedBackup operation",
...
export default deleteDBInstanceAutomatedBackup;
