...
import { RDSClient, ModifyGlobalClusterCommand } from "@aws-sdk/client-rds";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const modifyGlobalCluster: AppBlock = {
    ...
    default: {
      config: {
        ...
        AllowMajorVersionUpgrade: {
          ...
          description: "Specifies whether to allow major version upgrades.",
          type: "boolean",
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        const command = new ModifyGlobalClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Modify Global Cluster Result",
      description: "Result from ModifyGlobalCluster operation",
...
export default modifyGlobalCluster;
