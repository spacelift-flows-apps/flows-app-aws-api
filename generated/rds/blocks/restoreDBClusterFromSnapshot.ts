...
const restoreDBClusterFromSnapshot: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Restore DB Cluster From Snapshot Result",
      description: "Result from RestoreDBClusterFromSnapshot operation",
...
export default restoreDBClusterFromSnapshot;
