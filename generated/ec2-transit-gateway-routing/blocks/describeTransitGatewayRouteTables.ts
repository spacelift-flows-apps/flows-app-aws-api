...
const describeTransitGatewayRouteTables: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Transit Gateway Route Tables Result",
      description: "Result from DescribeTransitGatewayRouteTables operation",
...
export default describeTransitGatewayRouteTables;
