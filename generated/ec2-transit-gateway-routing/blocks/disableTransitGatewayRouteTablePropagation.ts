...
const disableTransitGatewayRouteTablePropagation: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DisableTransitGatewayRouteTablePropagationCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Disable Transit Gateway Route Table Propagation Result",
      description:
        "Result from DisableTransitGatewayRouteTablePropagation operation",
...
export default disableTransitGatewayRouteTablePropagation;
