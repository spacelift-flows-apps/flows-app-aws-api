...
const createTransitGatewayRoute: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreateTransitGatewayRouteCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Create Transit Gateway Route Result",
      description: "Result from CreateTransitGatewayRoute operation",
...
export default createTransitGatewayRoute;
