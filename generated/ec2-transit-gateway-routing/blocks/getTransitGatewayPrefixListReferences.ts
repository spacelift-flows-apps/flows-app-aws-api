...
const getTransitGatewayPrefixListReferences: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetTransitGatewayPrefixListReferencesCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Get Transit Gateway Prefix List References Result",
      description:
        "Result from GetTransitGatewayPrefixListReferences operation",
...
export default getTransitGatewayPrefixListReferences;
