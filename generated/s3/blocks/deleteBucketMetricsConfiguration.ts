...
const deleteBucketMetricsConfiguration: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Delete Bucket Metrics Configuration Result",
      description: "Result from DeleteBucketMetricsConfiguration operation",
...
export default deleteBucketMetricsConfiguration;
