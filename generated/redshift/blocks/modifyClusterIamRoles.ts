...
const modifyClusterIamRoles: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ModifyClusterIamRolesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Modify Cluster Iam Roles Result",
      description: "Result from ModifyClusterIamRoles operation",
...
export default modifyClusterIamRoles;
