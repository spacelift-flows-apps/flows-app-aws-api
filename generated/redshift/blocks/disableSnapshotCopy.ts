...
const disableSnapshotCopy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DisableSnapshotCopyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Disable Snapshot Copy Result",
      description: "Result from DisableSnapshotCopy operation",
...
export default disableSnapshotCopy;
