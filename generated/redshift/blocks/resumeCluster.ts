...
import { RedshiftClient, ResumeClusterCommand } from "@aws-sdk/client-redshift";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const resumeCluster: AppBlock = {
  name: "Resume Cluster",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ResumeClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Resume Cluster Result",
      description: "Result from ResumeCluster operation",
