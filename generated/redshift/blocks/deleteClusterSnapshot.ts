...
const deleteClusterSnapshot: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteClusterSnapshotCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Cluster Snapshot Result",
      description: "Result from DeleteClusterSnapshot operation",
...
export default deleteClusterSnapshot;
