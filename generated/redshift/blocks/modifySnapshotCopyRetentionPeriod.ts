...
const modifySnapshotCopyRetentionPeriod: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ModifySnapshotCopyRetentionPeriodCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Modify Snapshot Copy Retention Period Result",
      description: "Result from ModifySnapshotCopyRetentionPeriod operation",
...
export default modifySnapshotCopyRetentionPeriod;
