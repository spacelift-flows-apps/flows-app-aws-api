...
const deauthorizeDataShare: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeauthorizeDataShareCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Deauthorize Data Share Result",
      description: "Result from DeauthorizeDataShare operation",
...
export default deauthorizeDataShare;
