...
const authorizeEndpointAccess: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new AuthorizeEndpointAccessCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Authorize Endpoint Access Result",
      description: "Result from AuthorizeEndpointAccess operation",
...
export default authorizeEndpointAccess;
