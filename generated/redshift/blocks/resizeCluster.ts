...
import { RedshiftClient, ResizeClusterCommand } from "@aws-sdk/client-redshift";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const resizeCluster: AppBlock = {
  name: "Resize Cluster",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ResizeClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Resize Cluster Result",
      description: "Result from ResizeCluster operation",
