...
const rotateEncryptionKey: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new RotateEncryptionKeyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Rotate Encryption Key Result",
      description: "Result from RotateEncryptionKey operation",
...
export default rotateEncryptionKey;
