...
const enableSnapshotCopy: AppBlock = {
    ...
    default: {
      config: {
        ...
        ManualSnapshotRetentionPeriod: {
          ...
          description:
            "The number of days to retain newly copied snapshots in the destination Amazon Web Services Region after they are copied from the source Amazon Web Services Region.",
          type: "number",
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        const command = new EnableSnapshotCopyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Enable Snapshot Copy Result",
      description: "Result from EnableSnapshotCopy operation",
...
export default enableSnapshotCopy;
