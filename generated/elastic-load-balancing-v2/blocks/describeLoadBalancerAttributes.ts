...
const describeLoadBalancerAttributes: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Load Balancer Attributes Result",
      description: "Result from DescribeLoadBalancerAttributes operation",
...
export default describeLoadBalancerAttributes;
