...
const describeTrustStoreRevocations: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeTrustStoreRevocationsCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Describe Trust Store Revocations Result",
      description: "Result from DescribeTrustStoreRevocations operation",
...
export default describeTrustStoreRevocations;
