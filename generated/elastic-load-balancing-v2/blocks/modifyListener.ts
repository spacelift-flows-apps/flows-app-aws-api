...
const modifyListener: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ModifyListenerCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Modify Listener Result",
      description: "Result from ModifyListener operation",
