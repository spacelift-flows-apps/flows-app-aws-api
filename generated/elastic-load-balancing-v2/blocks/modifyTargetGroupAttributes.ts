...
const modifyTargetGroupAttributes: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Modify Target Group Attributes Result",
      description: "Result from ModifyTargetGroupAttributes operation",
...
export default modifyTargetGroupAttributes;
