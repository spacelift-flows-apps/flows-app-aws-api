...
const removeTrustStoreRevocations: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new RemoveTrustStoreRevocationsCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Remove Trust Store Revocations Result",
      description: "Result from RemoveTrustStoreRevocations operation",
...
export default removeTrustStoreRevocations;
