...
const describeCapacityReservation: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeCapacityReservationCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Describe Capacity Reservation Result",
      description: "Result from DescribeCapacityReservation operation",
...
export default describeCapacityReservation;
