...
const modifyTrustStore: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ModifyTrustStoreCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Modify Trust Store Result",
      description: "Result from ModifyTrustStore operation",
      ...
      type: {
        ...
        properties: {
          TrustStores: {
            ...
            description: "Information about the modified trust store.",
          },
        },
...
export default modifyTrustStore;
