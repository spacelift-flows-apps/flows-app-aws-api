...
const describeTrustStoreAssociations: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeTrustStoreAssociationsCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Describe Trust Store Associations Result",
      description: "Result from DescribeTrustStoreAssociations operation",
...
export default describeTrustStoreAssociations;
