...
const putNotificationConfiguration: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Put Notification Configuration Result",
      description: "Result from PutNotificationConfiguration operation",
...
export default putNotificationConfiguration;
