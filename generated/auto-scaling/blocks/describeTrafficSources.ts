...
const describeTrafficSources: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeTrafficSourcesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Describe Traffic Sources Result",
      description: "Result from DescribeTrafficSources operation",
...
export default describeTrafficSources;
