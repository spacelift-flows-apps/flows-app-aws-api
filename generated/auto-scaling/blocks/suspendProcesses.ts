...
const suspendProcesses: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new SuspendProcessesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Suspend Processes Result",
      description: "Result from SuspendProcesses operation",
...
export default suspendProcesses;
