...
const completeLifecycleAction: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CompleteLifecycleActionCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Complete Lifecycle Action Result",
      description: "Result from CompleteLifecycleAction operation",
...
export default completeLifecycleAction;
