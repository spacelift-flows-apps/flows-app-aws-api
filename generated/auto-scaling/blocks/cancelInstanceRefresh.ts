...
const cancelInstanceRefresh: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CancelInstanceRefreshCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Cancel Instance Refresh Result",
      description: "Result from CancelInstanceRefresh operation",
...
export default cancelInstanceRefresh;
