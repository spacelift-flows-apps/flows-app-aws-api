...
const recordLifecycleActionHeartbeat: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Record Lifecycle Action Heartbeat Result",
      description: "Result from RecordLifecycleActionHeartbeat operation",
...
export default recordLifecycleActionHeartbeat;
