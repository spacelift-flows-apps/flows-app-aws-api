...
const disableMetricsCollection: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Disable Metrics Collection Result",
      description: "Result from DisableMetricsCollection operation",
...
export default disableMetricsCollection;
