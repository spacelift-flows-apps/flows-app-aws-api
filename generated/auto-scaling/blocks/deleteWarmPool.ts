...
const deleteWarmPool: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteWarmPoolCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Warm Pool Result",
      description: "Result from DeleteWarmPool operation",
