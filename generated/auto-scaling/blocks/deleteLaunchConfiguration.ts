...
const deleteLaunchConfiguration: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Delete Launch Configuration Result",
      description: "Result from DeleteLaunchConfiguration operation",
...
export default deleteLaunchConfiguration;
