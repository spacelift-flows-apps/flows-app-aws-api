...
const attachTrafficSources: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new AttachTrafficSourcesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Attach Traffic Sources Result",
      description: "Result from AttachTrafficSources operation",
...
export default attachTrafficSources;
