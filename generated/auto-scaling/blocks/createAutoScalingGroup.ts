...
const createAutoScalingGroup: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreateAutoScalingGroupCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Create Auto Scaling Group Result",
      description: "Result from CreateAutoScalingGroup operation",
