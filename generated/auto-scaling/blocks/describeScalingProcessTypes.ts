...
const describeScalingProcessTypes: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Scaling Process Types Result",
      description: "Result from DescribeScalingProcessTypes operation",
...
export default describeScalingProcessTypes;
