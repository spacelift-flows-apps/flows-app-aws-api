...
const putWarmPool: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new PutWarmPoolCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Put Warm Pool Result",
      description: "Result from PutWarmPool operation",
