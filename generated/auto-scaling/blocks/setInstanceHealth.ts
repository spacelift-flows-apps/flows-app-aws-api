...
const setInstanceHealth: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new SetInstanceHealthCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Set Instance Health Result",
      description: "Result from SetInstanceHealth operation",
...
export default setInstanceHealth;
