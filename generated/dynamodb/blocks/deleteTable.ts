...
const deleteTable: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteTableCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Table Result",
      description: "Result from DeleteTable operation",
