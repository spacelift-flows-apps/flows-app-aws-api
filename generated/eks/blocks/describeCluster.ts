...
const describeCluster: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeClusterCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Describe Cluster Result",
      description: "Result from DescribeCluster operation",
