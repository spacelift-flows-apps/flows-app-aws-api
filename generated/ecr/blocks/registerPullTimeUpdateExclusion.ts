...
const registerPullTimeUpdateExclusion: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new RegisterPullTimeUpdateExclusionCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Register Pull Time Update Exclusion Result",
      description: "Result from RegisterPullTimeUpdateExclusion operation",
...
export default registerPullTimeUpdateExclusion;
