...
const enableHealthServiceAccessForOrganization: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Enable Health Service Access For Organization Result",
      description:
        "Result from EnableHealthServiceAccessForOrganization operation",
...
export default enableHealthServiceAccessForOrganization;
