...
const describeEventsForOrganization: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Events For Organization Result",
      description: "Result from DescribeEventsForOrganization operation",
...
export default describeEventsForOrganization;
