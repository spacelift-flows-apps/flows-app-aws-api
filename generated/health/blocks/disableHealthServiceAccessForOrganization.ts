...
const disableHealthServiceAccessForOrganization: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Disable Health Service Access For Organization Result",
      description:
        "Result from DisableHealthServiceAccessForOrganization operation",
...
export default disableHealthServiceAccessForOrganization;
