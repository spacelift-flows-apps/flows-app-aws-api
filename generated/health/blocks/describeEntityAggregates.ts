...
const describeEntityAggregates: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Entity Aggregates Result",
      description: "Result from DescribeEntityAggregates operation",
...
export default describeEntityAggregates;
