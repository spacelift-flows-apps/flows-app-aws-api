...
const deleteBackupVaultNotifications: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Delete Backup Vault Notifications Result",
      description: "Result from DeleteBackupVaultNotifications operation",
...
export default deleteBackupVaultNotifications;
