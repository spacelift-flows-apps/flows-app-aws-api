...
const getRestoreTestingInferredMetadata: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetRestoreTestingInferredMetadataCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Get Restore Testing Inferred Metadata Result",
      description: "Result from GetRestoreTestingInferredMetadata operation",
...
export default getRestoreTestingInferredMetadata;
