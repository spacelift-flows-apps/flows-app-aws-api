...
const exportBackupPlanTemplate: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ExportBackupPlanTemplateCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Export Backup Plan Template Result",
      description: "Result from ExportBackupPlanTemplate operation",
...
export default exportBackupPlanTemplate;
