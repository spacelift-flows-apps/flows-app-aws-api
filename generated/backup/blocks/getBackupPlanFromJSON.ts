...
const getBackupPlanFromJSON: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetBackupPlanFromJSONCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Get Backup Plan From JSON Result",
      description: "Result from GetBackupPlanFromJSON operation",
...
export default getBackupPlanFromJSON;
