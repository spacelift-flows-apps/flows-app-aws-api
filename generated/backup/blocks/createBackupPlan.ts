...
const createBackupPlan: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreateBackupPlanCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Create Backup Plan Result",
      description: "Result from CreateBackupPlan operation",
      ...
      type: {
        ...
        properties: {
          ...
          AdvancedBackupSettings: {
            ...
            description: "The settings for a resource type.",
          },
        },
        additionalProperties: true,
      },
...
export default createBackupPlan;
