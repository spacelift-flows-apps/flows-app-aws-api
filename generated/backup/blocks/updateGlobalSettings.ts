...
const updateGlobalSettings: AppBlock = {
    ...
    default: {
      config: {
        ...
        GlobalSettings: {
          ...
          description:
            "Inputs can include: A value for isCrossAccountBackupEnabled.",
          type: {
            type: "object",
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateGlobalSettingsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Global Settings Result",
      description: "Result from UpdateGlobalSettings operation",
