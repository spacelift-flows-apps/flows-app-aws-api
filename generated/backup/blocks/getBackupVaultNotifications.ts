...
const getBackupVaultNotifications: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Get Backup Vault Notifications Result",
      description: "Result from GetBackupVaultNotifications operation",
...
export default getBackupVaultNotifications;
