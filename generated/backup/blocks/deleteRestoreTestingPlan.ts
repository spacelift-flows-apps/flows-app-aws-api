...
const deleteRestoreTestingPlan: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteRestoreTestingPlanCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Delete Restore Testing Plan Result",
      description: "Result from DeleteRestoreTestingPlan operation",
...
export default deleteRestoreTestingPlan;
