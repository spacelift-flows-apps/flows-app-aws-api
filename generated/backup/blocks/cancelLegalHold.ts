...
const cancelLegalHold: AppBlock = {
  name: "Cancel Legal Hold",
  description: `Removes the specified legal hold on a recovery point.`,
  inputs: {
    default: {
      config: {
        region: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CancelLegalHoldCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Cancel Legal Hold Result",
      description: "Result from CancelLegalHold operation",
...
export default cancelLegalHold;
