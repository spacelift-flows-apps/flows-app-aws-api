...
const describeGlobalSettings: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeGlobalSettingsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Describe Global Settings Result",
      description: "Result from DescribeGlobalSettings operation",
      ...
      type: {
        ...
        properties: {
          ...
          LastUpdateTime: {
            type: "string",
            description:
              "The date and time that the supported flags were last updated.",
          },
        },
...
export default describeGlobalSettings;
