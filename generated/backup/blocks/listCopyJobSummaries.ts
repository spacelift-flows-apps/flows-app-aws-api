...
const listCopyJobSummaries: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListCopyJobSummariesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Copy Job Summaries Result",
      description: "Result from ListCopyJobSummaries operation",
...
export default listCopyJobSummaries;
