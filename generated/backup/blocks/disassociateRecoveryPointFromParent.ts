...
const disassociateRecoveryPointFromParent: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DisassociateRecoveryPointFromParentCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Disassociate Recovery Point From Parent Result",
      description: "Result from DisassociateRecoveryPointFromParent operation",
...
export default disassociateRecoveryPointFromParent;
