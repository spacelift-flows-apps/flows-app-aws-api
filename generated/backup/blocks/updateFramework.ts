...
import { BackupClient, UpdateFrameworkCommand } from "@aws-sdk/client-backup";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const updateFramework: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateFrameworkCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Framework Result",
      description: "Result from UpdateFramework operation",
