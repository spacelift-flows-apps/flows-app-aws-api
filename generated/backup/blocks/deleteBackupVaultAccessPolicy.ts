...
const deleteBackupVaultAccessPolicy: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Delete Backup Vault Access Policy Result",
      description: "Result from DeleteBackupVaultAccessPolicy operation",
...
export default deleteBackupVaultAccessPolicy;
