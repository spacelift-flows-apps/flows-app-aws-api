...
const listBackupPlanVersions: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListBackupPlanVersionsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Backup Plan Versions Result",
      description: "Result from ListBackupPlanVersions operation",
...
export default listBackupPlanVersions;
