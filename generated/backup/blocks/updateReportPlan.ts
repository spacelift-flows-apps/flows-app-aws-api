...
import { BackupClient, UpdateReportPlanCommand } from "@aws-sdk/client-backup";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const updateReportPlan: AppBlock = {
  ...
  inputs: {
    default: {
      config: {
        ...
        ReportSetting: {
          name: "Report Setting",
          description: "The report template for the report.",
          type: {
            type: "object",
            properties: {
              ReportTemplate: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateReportPlanCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Report Plan Result",
      description: "Result from UpdateReportPlan operation",
...
export default updateReportPlan;
