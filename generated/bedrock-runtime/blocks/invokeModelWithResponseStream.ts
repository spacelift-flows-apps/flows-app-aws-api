...
const invokeModelWithResponseStream: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Invoke Model With Response Stream Result",
      description: "Result from InvokeModelWithResponseStream operation",
...
export default invokeModelWithResponseStream;
