...
const addTagsToCertificate: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new AddTagsToCertificateCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Add Tags To Certificate Result",
      description: "Result from AddTagsToCertificate operation",
