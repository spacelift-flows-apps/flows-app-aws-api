...
const removeTagsFromCertificate: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Remove Tags From Certificate Result",
      description: "Result from RemoveTagsFromCertificate operation",
...
export default removeTagsFromCertificate;
