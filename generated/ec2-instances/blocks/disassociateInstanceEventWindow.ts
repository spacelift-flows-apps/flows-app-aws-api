...
const disassociateInstanceEventWindow: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DisassociateInstanceEventWindowCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Disassociate Instance Event Window Result",
      description: "Result from DisassociateInstanceEventWindow operation",
...
export default disassociateInstanceEventWindow;
