...
const getOTelEnrichment: AppBlock = {
  name: "Get O Tel Enrichment",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetOTelEnrichmentCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Get O Tel Enrichment Result",
      description: "Result from GetOTelEnrichment operation",
...
export default getOTelEnrichment;
