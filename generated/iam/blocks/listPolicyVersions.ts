...
import { IAMClient, ListPolicyVersionsCommand } from "@aws-sdk/client-iam";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listPolicyVersions: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListPolicyVersionsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Policy Versions Result",
      description: "Result from ListPolicyVersions operation",
...
export default listPolicyVersions;
