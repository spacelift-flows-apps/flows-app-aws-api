...
import { IAMClient, ListMFADeviceTagsCommand } from "@aws-sdk/client-iam";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listMFADeviceTags: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListMFADeviceTagsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List MFA Device Tags Result",
      description: "Result from ListMFADeviceTags operation",
...
export default listMFADeviceTags;
