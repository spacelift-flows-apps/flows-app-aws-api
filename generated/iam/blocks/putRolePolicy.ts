...
const putRolePolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new PutRolePolicyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Put Role Policy Result",
      description: "Result from PutRolePolicy operation",
