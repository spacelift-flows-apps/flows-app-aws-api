...
import { IAMClient, ListUserPoliciesCommand } from "@aws-sdk/client-iam";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listUserPolicies: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListUserPoliciesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List User Policies Result",
      description: "Result from ListUserPolicies operation",
...
export default listUserPolicies;
