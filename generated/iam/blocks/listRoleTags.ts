...
const listRoleTags: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListRoleTagsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Role Tags Result",
      description: "Result from ListRoleTags operation",
