...
const listAttachedUserPolicies: AppBlock = {
  ...
  outputs: {
    default: {
      name: "List Attached User Policies Result",
      description: "Result from ListAttachedUserPolicies operation",
...
export default listAttachedUserPolicies;
