...
import { IAMClient, ListGroupPoliciesCommand } from "@aws-sdk/client-iam";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listGroupPolicies: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListGroupPoliciesCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Group Policies Result",
      description: "Result from ListGroupPolicies operation",
...
export default listGroupPolicies;
