...
import { IAMClient, ListInstanceProfileTagsCommand } from "@aws-sdk/client-iam";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listInstanceProfileTags: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListInstanceProfileTagsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Instance Profile Tags Result",
      description: "Result from ListInstanceProfileTags operation",
...
export default listInstanceProfileTags;
