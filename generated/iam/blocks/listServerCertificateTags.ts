...
const listServerCertificateTags: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListServerCertificateTagsCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Server Certificate Tags Result",
      description: "Result from ListServerCertificateTags operation",
...
export default listServerCertificateTags;
