...
const listRegexPatternSets: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListRegexPatternSetsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Regex Pattern Sets Result",
      description: "Result from ListRegexPatternSets operation",
      ...
      type: {
        ...
        properties: {
          ...
          RegexPatternSets: {
            ...
            description: "An array of RegexPatternSetSummary objects.",
          },
        },
...
export default listRegexPatternSets;
