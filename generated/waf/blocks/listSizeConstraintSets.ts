...
import { WAFClient, ListSizeConstraintSetsCommand } from "@aws-sdk/client-waf";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listSizeConstraintSets: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListSizeConstraintSetsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Size Constraint Sets Result",
      description: "Result from ListSizeConstraintSets operation",
      ...
      type: {
        ...
        properties: {
          ...
          SizeConstraintSets: {
            ...
            description: "An array of SizeConstraintSetSummary objects.",
          },
        },
...
export default listSizeConstraintSets;
