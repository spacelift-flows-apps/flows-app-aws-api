...
import { WAFClient, ListGeoMatchSetsCommand } from "@aws-sdk/client-waf";
import { STSClient, AssumeRoleCommand } from "@aws-sdk/client-sts";

const listGeoMatchSets: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListGeoMatchSetsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Geo Match Sets Result",
      description: "Result from ListGeoMatchSets operation",
      ...
      type: {
        ...
        properties: {
          ...
          GeoMatchSets: {
            ...
            description: "An array of GeoMatchSetSummary objects.",
          },
        },
...
export default listGeoMatchSets;
