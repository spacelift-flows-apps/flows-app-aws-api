...
const putFunctionEventInvokeConfig: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Put Function Event Invoke Config Result",
      description: "Result from PutFunctionEventInvokeConfig operation",
...
export default putFunctionEventInvokeConfig;
