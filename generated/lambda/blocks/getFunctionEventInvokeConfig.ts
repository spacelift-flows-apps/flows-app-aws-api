...
const getFunctionEventInvokeConfig: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Get Function Event Invoke Config Result",
      description: "Result from GetFunctionEventInvokeConfig operation",
...
export default getFunctionEventInvokeConfig;
