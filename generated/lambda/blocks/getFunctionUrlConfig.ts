...
const getFunctionUrlConfig: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetFunctionUrlConfigCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Get Function Url Config Result",
      description: "Result from GetFunctionUrlConfig operation",
...
export default getFunctionUrlConfig;
