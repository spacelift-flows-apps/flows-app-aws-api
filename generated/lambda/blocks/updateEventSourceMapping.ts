...
const updateEventSourceMapping: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Update Event Source Mapping Result",
      description: "Result from UpdateEventSourceMapping operation",
...
export default updateEventSourceMapping;
