...
const getFunctionScalingConfig: AppBlock = {
  name: "Get Function Scaling Config",
  description: `Retrieves the scaling configuration for a Lambda Managed Instances function.`,
  inputs: {
    default: {
      config: {
        region: {
  ...
  outputs: {
    default: {
      name: "Get Function Scaling Config Result",
      description: "Result from GetFunctionScalingConfig operation",
...
export default getFunctionScalingConfig;
