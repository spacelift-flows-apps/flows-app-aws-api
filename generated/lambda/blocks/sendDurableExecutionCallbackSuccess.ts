...
const sendDurableExecutionCallbackSuccess: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Send Durable Execution Callback Success Result",
      description: "Result from SendDurableExecutionCallbackSuccess operation",
...
export default sendDurableExecutionCallbackSuccess;
