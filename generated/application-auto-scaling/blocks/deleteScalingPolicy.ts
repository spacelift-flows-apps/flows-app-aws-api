...
const deleteScalingPolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteScalingPolicyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Scaling Policy Result",
      description: "Result from DeleteScalingPolicy operation",
...
export default deleteScalingPolicy;
