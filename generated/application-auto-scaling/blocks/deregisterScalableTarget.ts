...
const deregisterScalableTarget: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Deregister Scalable Target Result",
      description: "Result from DeregisterScalableTarget operation",
...
export default deregisterScalableTarget;
