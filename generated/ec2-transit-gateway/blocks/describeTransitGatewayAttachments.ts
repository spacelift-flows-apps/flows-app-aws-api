...
const describeTransitGatewayAttachments: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Transit Gateway Attachments Result",
      description: "Result from DescribeTransitGatewayAttachments operation",
...
export default describeTransitGatewayAttachments;
