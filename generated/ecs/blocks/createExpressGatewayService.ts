...
const createExpressGatewayService: AppBlock = {
  name: "Create Express Gateway Service",
  description: `Creates an Express service that simplifies deploying containerized web applications on Amazon ECS with managed Amazon Web Services infrastructure.`,
  inputs: {
    default: {
      config: {
        region: {
        ...
        infrastructureRoleArn: {
          ...
          description:
            "The Amazon Resource Name (ARN) of the infrastructure role that grants Amazon ECS permission to create and manage Amazon Web Services resources on your behalf for the Express service.",
          type: "string",
          required: true,
        },
        serviceName: {
          name: "service Name",
          description: "The name of the Express service.",
          type: "string",
          required: false,
        },
        cluster: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreateExpressGatewayServiceCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Create Express Gateway Service Result",
      description: "Result from CreateExpressGatewayService operation",
...
export default createExpressGatewayService;
