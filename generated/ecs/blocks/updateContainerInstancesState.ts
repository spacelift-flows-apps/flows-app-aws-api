...
const updateContainerInstancesState: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Update Container Instances State Result",
      description: "Result from UpdateContainerInstancesState operation",
...
export default updateContainerInstancesState;
