...
const deregisterContainerInstance: AppBlock = {
  ...
  inputs: {
    default: {
      config: {
        ...
        force: {
          name: "force",
          description: "Forces the container instance to be deregistered.",
          type: "boolean",
          required: false,
        },
      },
  ...
  outputs: {
    default: {
      name: "Deregister Container Instance Result",
      description: "Result from DeregisterContainerInstance operation",
...
export default deregisterContainerInstance;
