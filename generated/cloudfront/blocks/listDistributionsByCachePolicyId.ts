...
const listDistributionsByCachePolicyId: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListDistributionsByCachePolicyIdCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Distributions By Cache Policy Id Result",
      description: "Result from ListDistributionsByCachePolicyId operation",
...
export default listDistributionsByCachePolicyId;
