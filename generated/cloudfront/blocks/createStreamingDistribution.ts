...
const createStreamingDistribution: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Create Streaming Distribution Result",
      description: "Result from CreateStreamingDistribution operation",
...
export default createStreamingDistribution;
