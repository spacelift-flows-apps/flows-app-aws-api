...
const describeConnectionFunction: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeConnectionFunctionCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Describe Connection Function Result",
      description: "Result from DescribeConnectionFunction operation",
      ...
      type: {
        ...
        properties: {
          ConnectionFunctionSummary: {
            ...
            additionalProperties: false,
            description: "The connection function's summary.",
          },
          ETag: {
            type: "string",
            description:
...
export default describeConnectionFunction;
