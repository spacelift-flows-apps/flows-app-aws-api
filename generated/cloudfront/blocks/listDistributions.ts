...
const listDistributions: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListDistributionsCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "List Distributions Result",
      description: "Result from ListDistributions operation",
