...
const listDistributionsByRealtimeLogConfig: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListDistributionsByRealtimeLogConfigCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Distributions By Realtime Log Config Result",
      description: "Result from ListDistributionsByRealtimeLogConfig operation",
...
export default listDistributionsByRealtimeLogConfig;
