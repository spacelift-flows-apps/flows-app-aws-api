...
const updateResponseHeadersPolicy: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Update Response Headers Policy Result",
      description: "Result from UpdateResponseHeadersPolicy operation",
...
export default updateResponseHeadersPolicy;
