...
const listDistributionsByTrustStore: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new ListDistributionsByTrustStoreCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "List Distributions By Trust Store Result",
      description: "Result from ListDistributionsByTrustStore operation",
...
export default listDistributionsByTrustStore;
