...
const createVpnConnectionRoute: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreateVpnConnectionRouteCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Create Vpn Connection Route Result",
      description: "Result from CreateVpnConnectionRoute operation",
...
export default createVpnConnectionRoute;
