...
const createLookupTable: AppBlock = {
  name: "Create Lookup Table",
  description: `Creates a lookup table by uploading CSV data.`,
  inputs: {
    default: {
      config: {
        region: {
      ...
      onEvent: async (input) => {
        ...
        const command = new CreateLookupTableCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Create Lookup Table Result",
      description: "Result from CreateLookupTable operation",
      ...
      type: {
        ...
        properties: {
          lookupTableArn: {
            type: "string",
            description: "The ARN of the lookup table that was created.",
          },
          createdAt: {
            type: "number",
            description:
