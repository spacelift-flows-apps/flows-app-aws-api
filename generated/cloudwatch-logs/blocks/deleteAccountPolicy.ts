...
const deleteAccountPolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteAccountPolicyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Account Policy Result",
      description: "Result from DeleteAccountPolicy operation",
