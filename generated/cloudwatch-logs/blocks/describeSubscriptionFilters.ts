...
const describeSubscriptionFilters: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Describe Subscription Filters Result",
      description: "Result from DescribeSubscriptionFilters operation",
...
export default describeSubscriptionFilters;
