...
const deleteSubscriptionFilter: AppBlock = {
  ...
  outputs: {
    default: {
      name: "Delete Subscription Filter Result",
      description: "Result from DeleteSubscriptionFilter operation",
...
export default deleteSubscriptionFilter;
