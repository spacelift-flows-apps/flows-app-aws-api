...
const putDeliveryDestinationPolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new PutDeliveryDestinationPolicyCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Put Delivery Destination Policy Result",
      description: "Result from PutDeliveryDestinationPolicy operation",
      ...
      type: {
        ...
        properties: {
          policy: {
            ...
            description: "The contents of the policy that you just created.",
          },
        },
...
export default putDeliveryDestinationPolicy;
