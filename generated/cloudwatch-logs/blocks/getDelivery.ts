...
const getDelivery: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetDeliveryCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Get Delivery Result",
      description: "Result from GetDelivery operation",
