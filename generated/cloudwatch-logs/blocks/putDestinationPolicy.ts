...
const putDestinationPolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new PutDestinationPolicyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Put Destination Policy Result",
      description: "Result from PutDestinationPolicy operation",
...
export default putDestinationPolicy;
