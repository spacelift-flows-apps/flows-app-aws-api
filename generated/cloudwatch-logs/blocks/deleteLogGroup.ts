...
const deleteLogGroup: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteLogGroupCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Log Group Result",
      description: "Result from DeleteLogGroup operation",
