...
const disassociateKmsKey: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DisassociateKmsKeyCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Disassociate Kms Key Result",
      description: "Result from DisassociateKmsKey operation",
...
export default disassociateKmsKey;
