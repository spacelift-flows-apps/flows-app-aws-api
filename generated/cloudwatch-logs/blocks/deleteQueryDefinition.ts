...
const deleteQueryDefinition: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteQueryDefinitionCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Query Definition Result",
      description: "Result from DeleteQueryDefinition operation",
...
export default deleteQueryDefinition;
