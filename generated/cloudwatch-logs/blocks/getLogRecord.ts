...
const getLogRecord: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new GetLogRecordCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Get Log Record Result",
      description: "Result from GetLogRecord operation",
