...
const deleteLogStream: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DeleteLogStreamCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Delete Log Stream Result",
      description: "Result from DeleteLogStream operation",
