...
const disableImageBlockPublicAccess: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DisableImageBlockPublicAccessCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Disable Image Block Public Access Result",
      description: "Result from DisableImageBlockPublicAccess operation",
...
export default disableImageBlockPublicAccess;
