...
const describeExportImageTasks: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new DescribeExportImageTasksCommand(
          commandInput as any,
        );
  ...
  outputs: {
    default: {
      name: "Describe Export Image Tasks Result",
      description: "Result from DescribeExportImageTasks operation",
...
export default describeExportImageTasks;
