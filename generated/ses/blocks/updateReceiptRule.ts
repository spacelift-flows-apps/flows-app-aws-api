...
const updateReceiptRule: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const command = new UpdateReceiptRuleCommand(commandInput as any);
  ...
  outputs: {
    default: {
      name: "Update Receipt Rule Result",
      description: "Result from UpdateReceiptRule operation",
...
export default updateReceiptRule;
